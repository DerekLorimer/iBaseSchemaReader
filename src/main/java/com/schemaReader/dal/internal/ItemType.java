...
import com.schemaReader.dal.ILabelPartInfo;
  ...
  implements IItemType, Comparable<ItemType>
{
  ...
  @Transient public  List<com.schemaReader.dal.sql.Column> getAllColumns() {
	  // Fix for SQLBuilder
	  List<com.schemaReader.dal.sql.Column> columns = new ArrayList<com.schemaReader.dal.sql.Column>();
	  this.mUnmodifiableAllFields.forEach( field -> {
		  columns.add(new com.schemaReader.dal.sql.Column(field.getPhysicalName(),"",field.getLogicalType()));
	  });
